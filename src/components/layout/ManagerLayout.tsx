        ...
        <div className="bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans w-full h-screen flex overflow-hidden">
            ...
            <aside className="hidden md:flex w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex-col shrink-0 z-20">
                <div className="h-16 flex items-center px-6 border-b border-slate-200 dark:border-slate-800">
                    ...
                    <h2 className="text-lg font-bold leading-tight tracking-tight">Gestão Municipal</h2>
                </div>
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex items-center gap-3">
                    ...
                    <div className="overflow-hidden">
                        <p className="text-sm font-semibold truncate text-slate-900 dark:text-slate-50">Gestor Município</p>
                        <p className="text-xs text-slate-500 dark:text-slate-400 truncate">gestor@prefeitura.gov.br</p>
                    </div>
                </div>
            </aside>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer">
                            <div className="text-right">
                                <p className="text-sm font-semibold leading-none">Carlos Silva</p>
                                <p className="text-xs text-slate-500 mt-1">Gestor de Mobilidade</p>
                            </div>
