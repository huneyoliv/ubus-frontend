...
import { ArrowLeft, Bus, MapPin, Clock, AlertTriangle } from 'lucide-react'

export default function Bilhete() {
    const navigate = useNavigate()
    const [time, setTime] = useState(new Date())
    const [isRelocated] = useState(false)
                    ...
                    <div className="w-full bg-white/15 backdrop-blur-md rounded-3xl p-6 border border-white/20">
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <p className="text-white font-bold text-base">Linha 2 - UNIT</p>
                                    <p className="text-white/70 text-xs">Ida • Horário: 18:00</p>
                                </div>
                            </div>
                            <div className="bg-white/20 px-3 py-1.5 rounded-full">
                                <p className="text-white text-xs font-bold">Poltrona 14</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div className="flex flex-col gap-6 flex-1">
                                <div>
                                    <p className="text-white/60 text-[10px] uppercase tracking-wider">Embarque</p>
                                    <p className="text-white font-semibold text-sm">Ponto Central • 18:00</p>
                                </div>
                                <div>
                                    <p className="text-white/60 text-[10px] uppercase tracking-wider">Desembarque</p>
                                    <p className="text-white font-semibold text-sm">Campus UNIT • 18:35</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-2 text-center">
                            <div>
                                ...
                                <p className="text-white text-xs font-semibold mt-1">João Silva</p>
                            </div>
                            <div>
                                <p className="text-white/50 text-[10px] uppercase">Matrícula</p>
                                <p className="text-white text-xs font-semibold mt-1 font-mono">202300158</p>
                            </div>
                            <div>
